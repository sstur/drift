...
shell.cp(thisPath + '/scaffold/config.js.txt', destPath + '/app/config/config.js');
shell.mkdir('-p', destPath + '/app/controllers');
shell.cp(thisPath + '/scaffold/controller.js.txt', destPath + '/app/controllers/main.js');
...
shell.cp(thisPath + '/scaffold/layout.html.txt', destPath + '/views/');
...
shell.cp(thisPath + '/scaffold/build-conf.json.txt', destPath + '/build-conf.json');
shell.cp(thisPath + '/scaffold/package.json.txt', destPath + '/package.json');
