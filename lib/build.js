...
(function() {
  ...
  function loadFile(path) {
    ...
    var directives = parseDirectives(filedata);
    //wrap commonJS-style modules
    if (directives.providesModule) {
      filedata = wrapModule(directives.providesModule, filedata);
    }
    //transform JSX and ES6
    if (directives.jsx) {
      filedata = transformES6(filedata);
    }
    //some special logic if file is named config.js
