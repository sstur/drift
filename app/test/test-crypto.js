...
app.on('ready', function(require) {
  ...
  app.addTestSuite('crypto', {
    ...
    'MD5 Test 4': function() {
      key = result; //d14b690f60f217b05e9f3206916a0da3
    ...
    'SHA256 Test 4': function() {
      key = result; //52c5a731acf66baf41bdd1cae3260c54566a73635b0559f5395a8ed5556e8e70
      keyBuffer = new Buffer(key, 'hex');
