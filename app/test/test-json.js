/*global app, define */
/*jshint -W053 */
/* eslint-disable quote-props, no-void, no-new-wrappers, one-var */
app.on('ready', function(require) {
  ...
  function canParse(source, message) { // eslint-disable-line no-unused-vars
    expect(function() {
      JSON.parse(source);
    }).to.not.throwError();
  }
