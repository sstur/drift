  ...
  exports.requestHandler = function (req, res) {
    var handleRequest = function() {
      ...
      try {
        ...
        console.log('fiber threw:', e);
        //send http 500
      }
    };
    //attempt to serve static file
    if (req.url.match(/^\/assets\//i)) {
      var opts = {root: basePath, path: req.url.split('?')[0]};
      staticServer.send(req, res, handleRequest, opts);
    } else {
      handleRequest();
    }
  };
